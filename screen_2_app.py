...
class RcSetupPage2App:
    ...
    def btn_exit(self):
        ...
        self.parent.j.write_to_json(COM_DATA.target_balloon_pressure, COM_DATA.target_chuck_pressure, self.parent.cv.CurBalUnits,
                                    self.parent.cv.CurClampUnits, self.parent.cv.CurDiaUnits, self.parent.cv.CurPosUnits,self.parent.TreeFileName)
